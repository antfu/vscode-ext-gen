...
export interface ConfigShorthandTypeMap {
  ...
  themeAnnotation: string,
  themeAnnotationMissing: string,
  themeAnnotationBorder: string,
  themeAnnotationMissingBorder: string,
  ...
  translateParallels: number,
  translatePromptSource: boolean,
  translateOverrideExisting: boolean,
  translateGoogleApiKey: (string | null),
  translateDeeplApiKey: (string | null),
  translateBaiduAppid: (string | null),
  translateBaiduApiSecret: (string | null),
  translateDeeplEnableLog: boolean,
  translateDeeplUseFreeApiEntry: boolean,
  translateLibreApiRoot: string,
  translateOpenaiApiKey: (string | null),
  translateOpenaiApiRoot: string,
  translateOpenaiApiModel: ("gpt-3.5-turbo" | "gpt-3.5-turbo-16k" | "gpt-3.5-turbo-0301" | "gpt-3.5-turbo-0613" | "gpt-4" | "gpt-4-0314" | "gpt-4-0613" | "gpt-4-32k" | "gpt-4-32k-0314" | "gpt-4-32k-0613"),
  usageScanningIgnore: (string[] | undefined),
  usageDerivedKeyRules: (string[] | null),
  frameworksRubyRailsScopeRoot: string,
  parsersTypescriptTsNodePath: string,
  parsersTypescriptCompilerOptions: Record<string, unknown>,
  parsersExtendFileExtensions: Record<string, unknown>,
  reviewEnabled: boolean,
  reviewGutters: boolean,
  reviewUserName: (string | undefined),
  reviewUserEmail: (string | undefined),
  reviewRemoveCommentOnResolved: boolean,
  editorPreferEditor: boolean,
  extractKeygenStrategy: ("slug" | "random" | "empty" | "source"),
  extractKeygenStyle: ("default" | "kebab-case" | "snake_case" | "camelCase" | "PascalCase" | "ALL_CAPS"),
  extractKeyPrefix: string,
  extractKeyMaxLength: (number | null),
  extractTargetPickingStrategy: ("none" | "most-similar" | "most-similar-by-key" | "file-previous" | "global-previous"),
  extractParsersHtml: Record<string, unknown>,
  extractParsersBabel: Record<string, unknown>,
  extractAutoDetect: boolean,
  extractIgnored: (string[] | undefined),
  extractIgnoredByFiles: Record<string, unknown>,
  ...
  vueI18nAllyLocalesPaths: (unknown | undefined),
  vueI18nAllyEncoding: (unknown | undefined),
  vueI18nAllySourceLanguage: (unknown | undefined),
  vueI18nAllyDisplayLanguage: (unknown | undefined),
  vueI18nAllyIgnoredLocales: (unknown | undefined),
  vueI18nAllyKeystyle: (unknown | undefined),
  vueI18nAllyDirStructure: (unknown | undefined),
  vueI18nAllyAnnotations: (unknown | undefined),
  vueI18nAllyAnnotationMaxLength: (unknown | undefined),
  vueI18nAllyAnnotationDelimiter: (unknown | undefined),
  vueI18nAllyFilenameMatchRegex: (unknown | undefined),
  vueI18nAllyIncludeSubfolders: (unknown | undefined),
  vueI18nAllyFullReloadOnChanged: (unknown | undefined),
  vueI18nAllySortKeys: (unknown | undefined),
  vueI18nAllyPreferredDelimiter: (unknown | undefined),
  vueI18nAllyReadonly: (unknown | undefined),
}
...
/**
 * Configs map registered by `lokalise.i18n-ally`
 */
